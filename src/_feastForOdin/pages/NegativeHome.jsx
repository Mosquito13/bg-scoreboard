...
const NegativeHome = () => {
  ...
  const handleClickNext = useCallback(() => {
    dispatch(setScoreByTypeAndCriteria({
      type: 'negative',
      criteria: negativeCriteria.HOME.key,
      score
    }));
    navigate('../feastForOdin/negative-exploration');
  }, [score, dispatch, navigate]);

  return (
    <NavigationStep onClickNext={handleClickNext}>
      <CriteriaTitle title={negativeCriteria.HOME.title} />
      <PlayerScoreInput
        score={score}
        players={playerList}
